...
\subsection{Baseline GNN}
The baseline GNN model achieves a training loss of $1.12 \times 10^{-2}$ and a validation loss of $1.02 \times 10^{-2}$ after 50 epochs. This serves as a reference point for evaluating the performance of the GKAN models.
