...
def visualize_symbolic_expressions(
    ...
    msg_dim = int(kan_model.msg_width[0][0] if isinstance(kan_model.msg_width[0], (list, list)) else kan_model.msg_width[0])
    node_dim = int(kan_model.node_width[0][0] if isinstance(kan_model.node_width[0], (list, list)) else kan_model.node_width[0])
